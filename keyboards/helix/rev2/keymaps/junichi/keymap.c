...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |Adjust| Caps |      | GUI  | Alt  |Lower |Space |Enter |Raise | Alt  | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,         KC_CAPS, _______, KC_LGUI, KC_LALT, LOWER, KC_SPC, KC_ENT, RAISE,   LCTL(KC_SPC),KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
    ),
