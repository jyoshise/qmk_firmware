...
<<<<<<< HEAD
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |Adjust| Caps |  GUI | Alt  |Shift |Lower |Space |Space |Raise |Shift | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_CAPS, KC_LGUI, KC_LALT, KC_LSFT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RSFT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
...
=======
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,         KC_CAPS, _______, _______, GUI_T(KC_INT5), LOWER, KC_SPC, KC_ENT, RAISE,ALT_T(KC_INT4),KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
    ),
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      |      |      |      |             |  _   |   +  |   [  |   ]  |   \  |   ~  |
>>>>>>> 3ea6816dd56b5b3b7d36d3d549ccc117f8357157
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      | Next | Vol- | Vol+ | Play |
   * `-------------------------------------------------------------------------------------------------'
   */
...
=======
      ...
      _______,   KC_F11,   KC_F12,   KC_F13,   KC_F14,   KC_F15,                    KC_F16,   KC_F17,  KC_COMM,   KC_DOT,  KC_SLSH,  KC_RSFT,\
...
=======
   * |      |      |      |Aud on|Audoff| Mac  |             | LEFT |  UP  | DOWN | RIGHT|      |      |
>>>>>>> 3ea6816dd56b5b3b7d36d3d549ccc117f8357157
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
...
>>>>>>> 3ea6816dd56b5b3b7d36d3d549ccc117f8357157
      _______, _______, _______, _______, _______, _______,                   _______, RGBRST, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
...
void render_status(struct CharacterMatrix *matrix) {
  ...
  // Render to mode icon
  static char logo[][2][3]={{{0x95,0x96,0},{0xb5,0xb6,0}},{{0x97,0x98,0},{0xb7,0xb8,0}},{{0x99,0x9a,0},{0xb9,0xba,0}}};
