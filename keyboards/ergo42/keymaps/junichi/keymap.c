...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    S(KC_8),       S(KC_9),    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_ESC,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    S(KC_RBRC),    S(KC_BSLS), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
    _______, KC_CAPS, KC_LGUI, KC_LALT, KC_LSFT, MO(LOWER),   KC_SPC,        KC_SPC,     MO(RAISE),   KC_RSFT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
