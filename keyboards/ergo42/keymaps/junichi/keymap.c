...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |Adjust| Caps |  GUI | Alt  | Alt  |Lower |Shift/Space |Shift/Space |Raise |Alt | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [QWERTY] = LAYOUT( \
    ...
    _______, KC_CAPS, _______, KC_LGUI, KC_LALT, MO(LOWER),   LSFT_T(KC_SPC),        RSFT_T(KC_SPC),     MO(RAISE),   KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
